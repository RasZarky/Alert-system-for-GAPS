...
class AdminFarmersWidget extends StatefulWidget {
  AdminFarmersWidget({
    Key? key,
  }) : super(key: key);

  @override
  State<AdminFarmersWidget> createState() => _AdminFarmersWidgetState();
}

class _AdminFarmersWidgetState extends State<AdminFarmersWidget> {
  ...
  Future<void> _loadItems() async {
    ...
    _firestore.collection('farmers').snapshots().listen((snapshot) {
      setState(() {
  ...
  void _onSearchChanged() {
    setState(() {
      _filteredItems = _allItems.where((item) {
        ...
        final id = data["officerId"] as String;
